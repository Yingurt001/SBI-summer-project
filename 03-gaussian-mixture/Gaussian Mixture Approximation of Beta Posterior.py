...
θ ∼ Beta(2,5), y ∼ Binomial(n=100, θ), M=10⁶ sims.
Define own MixtureDensityNN(K=8) (slightly different backbone sizes than modles.py).
Train only the MoG by maximizing the mixture log-likelihood of θ|y, looping over y∈[0..100].
For a single y_obs, plots true Beta posterior vs the learned MoG.
